...
func addDeleteResponses(doc *openapi3.T) {
	successDesc := "Returns the deleted project."
	doc.Components.Responses["delete_project_v1_ok"] = &openapi3.ResponseRef{
...
func addDeleteOperation(doc *openapi3.T) {
	...
	op.Description = "Deletes the project with the specified id."
	...
	doc.AddOperation("/v1/projects/{id}", "DELETE", op)
}