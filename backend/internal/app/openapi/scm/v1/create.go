...
func addCreateRequestBody(doc *openapi3.T) {
	...
	dto := &openapi3.SchemaRef{
		Value: &openapi3.Schema{
			...
			Required: []string{"name", "type", "token", "endpoint"},
	...
	doc.Components.Schemas["add_scm_integration_v1_request_body"] = dto
}

func addCreateResponses(doc *openapi3.T) {
	successDesc := "The created SCM Integration."
	doc.Components.Responses["create_scm_integration_v1_ok"] = &openapi3.ResponseRef{
	...
	doc.Components.Responses["create_scm_integration_v1_invalid"] = &openapi3.ResponseRef{
		Value: &openapi3.Response{
...
func addCreateOperation(doc *openapi3.T) {
	...
	op.Description = "Creates a new SCM Integration defined by the request body."
	...
	doc.AddOperation("/v1/scm-integrations", "POST", op)
}