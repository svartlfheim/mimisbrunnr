...
import (
	...
	rdbmocks "github.com/svartlfheim/mimisbrunnr/test/mocks/infra/rdb"
...
func Test_ConnectionManager_GetConnection(t *testing.T) {
	...
	buildConnectionManager := func(o *rdbmocks.ConnectionOpener) *ConnectionManager {
		l := zerologmocks.NewLogger()
	...
	t.Run("no connection - fails for non postgres driver", func(tt *testing.T) {
		opener := &rdbmocks.ConnectionOpener{}
